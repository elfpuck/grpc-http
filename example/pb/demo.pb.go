...
type Ping struct {
	...
	Data string `protobuf:"bytes,1,opt,name=Data,proto3" json:"Data,omitempty"` // 发送的消息内容
}
...
type Pong struct {
	...
	Data string `protobuf:"bytes,2,opt,name=Data,proto3" json:"Data,omitempty"` // 返回的消息内容
}
...
var file_pb_demo_proto_rawDesc = []byte{
	...
	0x04, 0x64, 0x65, 0x6d, 0x6f, 0x22, 0x1a, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12, 0x12, 0x0a,
	0x04, 0x44, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x44, 0x61, 0x74,
	0x61, 0x22, 0x1a, 0x0a, 0x04, 0x50, 0x6f, 0x6e, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x44, 0x61, 0x74,
	0x61, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x44, 0x61, 0x74, 0x61, 0x32, 0x28, 0x0a,
	0x04, 0x44, 0x65, 0x6d, 0x6f, 0x12, 0x20, 0x0a, 0x04, 0x65, 0x63, 0x68, 0x6f, 0x12, 0x0a, 0x2e,
	0x64, 0x65, 0x6d, 0x6f, 0x2e, 0x50, 0x69, 0x6e, 0x67, 0x1a, 0x0a, 0x2e, 0x64, 0x65, 0x6d, 0x6f,
	0x2e, 0x50, 0x6f, 0x6e, 0x67, 0x22, 0x00, 0x42, 0x09, 0x5a, 0x07, 0x70, 0x62, 0x3b, 0x64, 0x65,
...
var file_pb_demo_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_pb_demo_proto_goTypes = []interface{}{
	(*Ping)(nil), // 0: demo.Ping
	(*Pong)(nil), // 1: demo.Pong
}
var file_pb_demo_proto_depIdxs = []int32{
	0, // 0: demo.Demo.echo:input_type -> demo.Ping
	1, // 1: demo.Demo.echo:output_type -> demo.Pong
...
func (c *demoClient) Echo(ctx context.Context, in *Ping, opts ...grpc.CallOption) (*Pong, error) {
	out := new(Pong)
...
func (*UnimplementedDemoServer) Echo(context.Context, *Ping) (*Pong, error) {
...
func _Demo_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DemoServer).Echo(ctx, req.(*Ping))
	}
