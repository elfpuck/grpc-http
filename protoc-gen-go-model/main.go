...
func generateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	filename := file.GeneratedFilenamePrefix + ".model.pb.go"
	...
	g.P("// \tAddress ", "https://github.com/elfpuck/grpc-http/protoc-gen-go-moodel")
	g.P("// \t")
	g.P("// \tversion: ")
...
func generateFileContent(file *protogen.File, g *protogen.GeneratedFile) {
	...
	for _, service := range file.Services {
		...
		data.Methods = append(data.Methods, methodArr...)
	}
...
func executeTemplate(data *PackageData) string {
	t := template.Must(template.New("model.pb.go").Parse(TEMPLATE))
